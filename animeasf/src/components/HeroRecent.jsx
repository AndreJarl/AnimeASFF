    ...
    const  [animes, setAnimes] = useState(null); 
      ...
      return (
        <div className='flex flex-col content-center items-center' >
              ...
              <Link to="/recentanimes" style={{textDecoration: 'none'}}> <button className='flex text-center content-center mt-5 bg-gray-700 px-8 py-4 mb-5 rounded lg:px-5 lg:py-2 lg:text-sm'>See More</button></Link> 
            </div>
          {animes.length > 0 ? (
